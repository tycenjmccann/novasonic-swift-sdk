...
public struct BedrockEvents {
    ...
    public static func sessionUpdateEvent(voice: String? = nil, instructions: String? = nil, replace: [String: String]? = nil, languageHint: String? = nil, keyterms: [String]? = nil) -> String {
