...
public enum NovaSonicError: Error, LocalizedError {
    ...
    public var recoverySuggestion: String? {
        ...
        case .validationFailed(let field, _):
            return "Check the '\(field)' parameter in your NovaSonicConfiguration"
        case .converterCreationFailed:
            return "Try restarting the audio session"
        case .sessionConfigurationFailed:
    ...
    public var isRetryable: Bool {
        ...
        case .networkConnectionFailed, .serviceUnavailable, .rateLimitExceeded, .sessionTimeout:
            return true
        case .audioPermissionDenied, .authenticationFailed, .invalidConfiguration, .microphoneNotAvailable, .validationFailed:
            return false
